   ...
   <div class="container-fluid">
      <div class="card">
         ...
         <div class="table-responsive card-body">
            <form method="post" action="<?= base_url('sosmeds/update/'.encrypt_decrypt('encrypt', $sosmed->id)) ?>">
                <div class="mb-3">
                   <label for="name" class="form-label">Nama Media Sosial</label>
                   <input type="text" class="form-control" id="name" value="<?= set_value('name', $sosmed->name) ?>" name="name" required placeholder="">
               ...
               <div class="mb-3">
                   ...
                   <div class="input-group">
                     ...
                     <input type="text" class="form-control" id="icon" value="<?= set_value('icon', $sosmed->icon) ?>" name="icon" required placeholder="">
                   </div>
